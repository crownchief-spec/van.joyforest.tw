...
<figure class="guide-figure">
  ...
  <figcaption><span class="guide-img-title">傍晚山景｜泡完湯，不急著再趕下一段路</span>溫泉多位於山區或山谷，和露營車喜歡的慢旅行節奏很搭。</figcaption>
</figure>

<div class="guide-grid-2 hot-spring-photo-grid">
  <figure class="guide-figure">
    <img src="/assets/images/trip-ideas/hot-spring-campervan-overnight/guanziling-hot-spring-campervan-overnight.webp" width="480" height="360" loading="lazy" decoding="async" title="關子嶺森之湯池畔露營車停留實景" alt="夜間溫泉池旁停放一輛白色露營車，呈現關子嶺泡湯與露營車過夜的實際情境" />
    <figcaption><span class="guide-img-title">池畔實景｜露營車與溫泉在同一站</span>這種玩法的價值不是塞更多景點，而是泡湯後能把步調慢下來。</figcaption>
  </figure>
  <figure class="guide-figure">
    <img src="/assets/images/trip-ideas/hot-spring-campervan-overnight/guanziling-sen-spa-sign.webp" width="675" height="900" loading="lazy" decoding="async" title="森之湯脈衝 SPA 親子水樂園現場標示" alt="台南關子嶺森之湯脈衝 SPA 親子水樂園招牌，標示成人無邊際池水深一百二十公分" />
    <figcaption><span class="guide-img-title">現場標示｜森之湯脈衝 SPA 親子水樂園</span>有成人池、SPA 與親子區，入池前仍要依現場規則使用。</figcaption>
  </figure>
</div>

<div class="guide-grid-2 hot-spring-photo-grid">
  <figure class="guide-figure">
    <img src="/assets/images/trip-ideas/hot-spring-campervan-overnight/guanziling-sen-spa-hydrotherapy-pools.webp" width="480" height="360" loading="lazy" decoding="async" title="關子嶺森之湯水療 SPA 池" alt="關子嶺森之湯夜間水療池，多座溫泉池設有扶手、座椅與按摩水柱" />
    <figcaption><span class="guide-img-title">水療池｜把移動日變成放鬆日</span>長途移動後先休息、補水，再依身體狀況泡湯。</figcaption>
  </figure>
  <figure class="guide-figure">
    <img src="/assets/images/trip-ideas/hot-spring-campervan-overnight/guanziling-mud-hot-spring-jets.webp" width="360" height="480" loading="lazy" decoding="async" title="關子嶺泥漿溫泉按摩水柱" alt="帶有關子嶺泥漿溫泉色澤的水療池，池邊水柱持續注入溫泉水" />
    <figcaption><span class="guide-img-title">關子嶺泉色｜山區溫泉旅行的辨識度</span>實際開放池別與水溫以當日現場公告為準。</figcaption>
  </figure>
</div>

<figure class="guide-figure">
  <img src="/assets/images/trip-ideas/hot-spring-campervan-overnight/guanziling-family-water-play-area.webp" width="480" height="360" loading="lazy" decoding="async" title="關子嶺森之湯親子水樂園" alt="關子嶺森之湯親子戲水區設有蘑菇瀑布與地面噴泉，親子可在山林旁玩水" />
  <figcaption><span class="guide-img-title">親子玩水｜同一站照顧大人與孩子</span>若帶孩子，訂位時也要確認開放年齡、池深、泳裝泳帽與陪同規定。</figcaption>
</figure>
...
<ol class="checklist hot-spring-booking-checklist">
  ...
  <li>車高約 <strong>3 公尺</strong>，入口有沒有樹枝、棚架、限高或地下停車場？</li>
  <li>費用按一車、一個營位還是按人計算？平假日規則是什麼？</li>
  <li>泡湯是<strong>包含在車宿費用</strong>，還是要另外買票？可用一次還是可重複進場？</li>
  <li>可以使用車邊帳、桌椅或簡單開伙嗎？最晚安靜時間是幾點？</li>
  <li>有沒有 110V 供電？插座安培數、延長線距離與用水位置為何？</li>
  <li>有廁所、淋浴、垃圾與污水處理嗎？禁止把生活污水直接排在地面。</li>
  <li>入住、退場時間、休園日、臨時維護與豪雨／颱風退改規則是什麼？</li>
</ol>

## 為什麼溫泉車宿特別適合喜歡山裡的人？

許多溫泉帶就在山谷、溪流或森林附近。露營車把床、簡易廚房與衛浴帶在身邊，旅人不必為了住飯店排滿行程，也不必泡完湯再摸黑趕很遠。更適合的節奏是：白天只走一兩個點，傍晚抵達、確認車位與水電，休息後泡湯，隔天睡飽再繼續山線。

但山區也要多一層準備：先看天氣與道路、避免豪雨後進入不熟的小路、注意落石與低垂樹枝，並替下坡留足煞車距離。溫泉車宿的「慢」，不是停在任何空地，而是事先找到<strong>獲允許、能安全進出、規則講清楚</strong>的過夜點。
